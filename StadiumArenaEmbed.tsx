...
export function StadiumArenaEmbed({
  compact = false,
  flush = false,
  battleMode = 'arena',
  battleStatus = 'live',
  ...
  const fighterPaths = useMemo(() => {
    // Render the correctly sliced kick sprite sheet for both sides of the experiment
    return [
      '/2dgame/data/fighters/stadium-kick.json?v=6'
    ];
  }, []);
